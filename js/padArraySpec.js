...
// console.log(padArray.pad([1,2,3], 5), [1,2,3, null, null])
// console.log((padArray.pad([1,2,3], 5, 'apple'), [1,2,3, 'apple', 'apple']))
// console.log((padArray.pad([1,2,3], 3), [1,2,3]))
console.log((padArray.pad([1,2,3,4,5], 3), [1,2,3]))
